...
public class LoopEx2 {
	...
	public void method9() { 
		...
		for(int row=1; row<=4; row++) { // 4행 (1,2,3,4) 
			for(int col=1; col<=row; col++) {// 4열 (1,2,3,4)
				System.out.print("*");
			}
			System.out.println();
		}
	...
	public void method10() {
		...
		for(int row=3; row>=0; row--) { // 4행 (1,2,3,4) 
			for(int col=0; col<row+1; col++) {// 4열 (1,2,3,4)
				System.out.print("*");
			}
			System.out.println();
		}
