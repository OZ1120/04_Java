...
public class FileService {
	 ...
	 *     윈도우에서 쓴거 맥에서 인식되고, 맥에서 쓴거 윈도우에서 설명가능
	 *     
	 ...
	 * 
	 * 서울시 중구 남대문로 ㅇㅇㅇ 서브웨이
	 * 서울시 강남구 000지오다노									얘네 절대기준 서울시
	 * 서울시 금천구 000 0000
	 * 
	 * - 기준
	 * [Windows] : C:/ , D:/
	...
	public void method3() {
		...
		// 향상된 for문 -> for(요소 저장 변수 : 배열|컬렉션(list,set))
		for( File f : files) {
...
//			System.out.println(f.toString());
			...
			// 마지막으로 수정한 날짜
			long lastModifide = f.lastModified();
			// System.out.println(lastModifide);
			...
			String date = sdf.format(lastModifide );
