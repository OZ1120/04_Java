...
public class JavaAPIService {
	...
	public void method1() {
		...
		int num3 = wrap1; // 컴파일러가 Auto Unboxing 수행코드 추가
	...
	public void method2() {
		...
		String change3 = test3 + ""; // long + Stirng -> String + String -> 이어쓰기
	...
	public void method3() {
		...
		// -> 주소 값을 이용해서 만든 해시코드(식별변호)
		// -> 같은 객체에 저장된 값이 변했다면 주소는 일정해야 된다!
		//  -> identityHashCode도 일정해야 된다!!
	 ...
	 * - 동일할 리터럴을 이용해 String 객체를 생성한 경우
	 * 	 추가적으로 객체를 생성하지 않고
	 *   기존에 존재하는 String객체의 주소를 반환(재활용)
	 */
	public void method4() {
	...
	public void method5() {
		...
		// 셋다 주소가 다름 == "abcd"를 재활용 하지 않음
		// -> 값은 같지만 전부 다른 객체
	}
	
	/**
	 * StringBilder / StringBuffer 클래스
	 ...
	 *   -> 마음대로 문자열 수정, 삭제 가능!
	 *   -> 수정, 삭제를 해도 추가적인 객체 생성이 없어 효율좋음!
	 *   
	 * - StringBilder : Thread Safe 미제공 (비동기, 추천)
