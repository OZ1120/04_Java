...
//		List list = new ArrayList(); // 10칸 짜리 생성
		...
		for(int i=0; i<list.size(); i++) {
			...
			// List의 i번째 요소가 double (-> Double 변환)인경우
	...
	public void method2() {
		...
		// 3. voic add(int index, E e) : index 번째에 중간 삽입
		strList.add(1,"찜닭");
		...
		System.out.println("수정 전 :"+ strList.get(2));
		System.out.println(strList);
		...
		// List 내부에 e와 같은 요고사 있으면 true , 없으면 false
...
//		List<Book> bookList = new ArrayList<Book>()	;
		...
		do {
			...
			sc.nextLine(); // 스태너 버퍼에 남아 있는 개행 분자 제거
			...
			case 3:
				...
				System.out.print("조회할 책의 인데스 입력 : ");
			...
			case 4: // index를 정상적으로 입력했다고 가정
				...
				Book before = bookList.set(index, after); // 책 바꾸고 이전책 추출
