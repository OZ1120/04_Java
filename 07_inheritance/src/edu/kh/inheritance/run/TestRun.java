...
public class TestRun {
	...
	public static void main(String[] args) {
		...
		Child2 c3 = new Child2("최", "서울시 강남구" , 999_999_999, 
				" 벤츠" , "아이폰 15");
		...
		ch1.testMethod();
		ch2.testMethod();
		// 부모에 코드 추가/수정하면 모든 자식한테도 코드가 추가된다!!
		
		
		// 오버라이딩 확인하기
		System.out.println("----- 오버 라이딩 =====");
		System.out.println(ch1.introduce());
		System.out.println(ch2.introduce());
		
		System.out.println("---- toString90 오버라이딩()----");
