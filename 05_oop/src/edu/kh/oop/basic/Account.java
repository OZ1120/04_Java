...
public class Account {
	...
	private String accountNumber; // 게좌 번호
	...
	public String getName() {
		return name; //Void methods cannot return a value 보이드가 작성된 메서드는 값 리턴 못함
	}
	...
	// accountNumber 값을 반환하는 간접접근 기능
	public String getAccountNumber() {
		return accountNumber;
	}
	
	
	// passworb 값 세팅하는 간접접근 기능
	public void setPassword(String password) {
		this.password = password;
	}
	
	// balance 값을 반환하는 간접접근 기능
